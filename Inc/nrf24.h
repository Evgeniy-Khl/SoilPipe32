...
//------------------------------------------------
#define NRF_CSN_lo      HAL_GPIO_WritePin(NRF_CSN_GPIO_Port, NRF_CSN_Pin, GPIO_PIN_RESET)
#define NRF_CSN_hi      HAL_GPIO_WritePin(NRF_CSN_GPIO_Port, NRF_CSN_Pin, GPIO_PIN_SET)
#define NRF_CE_lo       HAL_GPIO_WritePin(NRF_CE_GPIO_Port, NRF_CE_Pin, GPIO_PIN_RESET)
#define NRF_CE_hi       HAL_GPIO_WritePin(NRF_CE_GPIO_Port, NRF_CE_Pin, GPIO_PIN_SET)
...
/*----------------- Регистры ---------------------*/
#define CONFIGDATA  ((1<<PWR_UP) | (1<<EN_CRC) | (0<<CRCO) | (1<<PRIM_RX)) // режим приёмника 2+8+1 = 11
...
#define TX_PLOAD_WIDTH  DATA_TEMPR + AMOUNT_SENS + INTERVAL + ENERGY + CRC8 // 12 байт
//------------------------------------------------
